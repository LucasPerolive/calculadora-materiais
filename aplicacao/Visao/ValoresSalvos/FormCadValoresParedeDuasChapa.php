...
<html>
    ...
    <body>
        ...
        <div class="conteudo">
            <h1>Parede simples com duas chapas de cada lado</h1>
            <?php
                switch ($tipo_chapa){
                    case "RU":
                        echo "<p>Chapa RU BR 12,5mm em cada face</p>
                        <p>Quantitativo estimado - Parede simples com duas chapa de cada lado</p>";
                        break;
                    case "ST":
                        echo "<p>Chapa ST BR 12,5mm em cada face</p>
                        <p>Quantitativo estimado - Parede simples com duas chapas de cada lado</p>";
                        break;
                    case "RF":
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $quantidade_chapas = ($calculadora->QuantidadeChapasParede($area_parede) * 2);
                                ...
                                echo "<td><input type='number' name='valor_parafuso'></td>
